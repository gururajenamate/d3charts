...
jQuery.sap.require("d3charts.utils.Formatter");
jQuery.sap.declare("d3charts.MiniGauge");

sap.ui.core.Element.extend("d3charts.MiniGaugeItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("d3charts.MiniGauge", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "Minigauge Chart Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.MiniGaugeItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.MiniGauge.init()");
		this.sParentId = "";
	},
	
	
	createGauges : function() {
		console.log("d3charts.MiniGauge.createGauges()");
	...
	onAfterRendering: function(){
		console.log("d3charts.MiniGauge.onAfterRendering()");
		...
		chart.append("text")
		    ...
		    .attr("text-anchor", "middle")
		    .text(function(d) {
		    	var formattedFC = d3charts.utils.Formatter.amount(d.forecast);
		    	return formattedFC;
			})
		   	.attr("font-family", "sans-serif")
		   	.attr("font-size", "14px")
		...
		chart.append("text")
		    ...
		    .attr("text-anchor", "middle")
		    .text(function(d) {
		    	var formattedBG = d3charts.utils.Formatter.amount(d.budget);
		    	return formattedBG;
			})
		   	.attr("font-family", "sans-serif")
		   	.attr("font-size", "14px")
