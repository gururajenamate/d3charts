...
jQuery.sap.declare("d3charts.PerformanceToTargetComparison");

sap.ui.core.Element.extend("d3charts.PerformanceToTargetComparisonItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("d3charts.PerformanceToTargetComparison", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "PerformanceToTargetComparison Chart Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.PerformanceToTargetComparisonItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.PerformanceToTargetComparison.init()");
		this.sParentId = "";
	},
	...
	createComparison : function() {
		 ...
		 */
		console.log("d3charts.PerformanceToTargetComparison.createComparison()");
	...
	onAfterRendering: function(){
		console.log("d3charts.PerformanceToTargetComparison.onAfterRendering()");
