...
jQuery.sap.declare("d3charts.StackedBarChart");

sap.ui.core.Element.extend("d3charts.StackedBarChartItem", { metadata : {
	properties : {
		"quarter" : {type : "string", group : "Misc", defaultValue : null},
		"values" : {type : "object", group : "Misc", defaultValue : null}	
	}
}});	
sap.ui.core.Control.extend("d3charts.StackedBarChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "StackedBarChart Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.StackedBarChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.StackedBarChart.init()");
		this.sParentId = "";
	},
	...
	createStackedBarChart : function() {
		 ...
		 */
		console.log("d3charts.StackedBarChart.createStackedBarChart()");
	...
	onAfterRendering: function(){
		console.log("d3charts.StackedBarChart.onAfterRendering()");
