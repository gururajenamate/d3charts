...
jQuery.sap.declare("d3charts.Chart");

sap.ui.core.Element.extend("d3charts.ChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("d3charts.Chart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "Chart Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.ChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.Chart.init()");
		this.sParentId = "";
	},
	...
	createChart : function() {
		 ...
		 */
		console.log("d3charts.Chart.createChart()");
	...
	onAfterRendering: function(){
		console.log("d3charts.Chart.onAfterRendering()");
