...
jQuery.sap.declare("d3charts.ScatterPlot");

sap.ui.core.Element.extend("d3charts.ScatterPlotItem", { metadata : {
	properties : {
		"quarter" : {type : "string", group : "Misc", defaultValue : null},
		"values" : {type : "object", group : "Misc", defaultValue : null}	
	}
}});	
sap.ui.core.Control.extend("d3charts.ScatterPlot", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "ScatterPlot Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.ScatterPlotItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.ScatterPlot.init()");
		this.sParentId = "";
	},
	...
	createScatterPlot : function() {
		 ...
		 */
		console.log("d3charts.ScatterPlot.createScatterPlot()");
	...
	onAfterRendering: function(){
		console.log("d3charts.ScatterPlot.onAfterRendering()");
