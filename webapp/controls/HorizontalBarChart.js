...
jQuery.sap.declare("d3charts.HorizontalBarChart");

sap.ui.core.Element.extend("d3charts.HorizontalBarChartItem", { metadata : {
	properties : {
...
sap.ui.core.Control.extend("d3charts.HorizontalBarChart", {
	metadata : {
		properties: {
			"title": {type : "string", group : "Misc", defaultValue : "HorizontalBarChart Title"}
		},
		aggregations : {
			"items" : { type: "d3charts.HorizontalBarChartItem", multiple : true, singularName : "item"}
		}
		,
	...
	init : function() {
		console.log("d3charts.HorizontalBarChart.init()");
		this.sParentId = "";
	},
	...
	createHorizontalBarChart : function() {
		 ...
		 */
		console.log("d3charts.HorizontalBarChart.createHorizontalBarChart()");
	...
	onAfterRendering: function(){
		console.log("d3charts.HorizontalBarChart.onAfterRendering()");
